...
document.getElementById('dateSubmitted').textContent = urlParams.get('dateSubmitted');
document.getElementById('timeSubmitted').textContent = urlParams.get('timeSubmitted');